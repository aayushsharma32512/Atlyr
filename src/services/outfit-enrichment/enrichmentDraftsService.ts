...
const DRAFT_SELECT = `
  ...
  created_at,
  updated_at,
  outfit:outfits!outfit_enrichment_drafts_outfit_id_fkey(id, name, outfit_images)
`
...
export async function fetchDraftsByStatus(
    ...
    return (data ?? []) as unknown as EnrichmentDraft[]
}
...
export async function fetchDraftById(
    ...
    return data as unknown as EnrichmentDraft | null
}
