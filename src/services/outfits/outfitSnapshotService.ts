...
export async function captureAndUploadOutfitSnapshot(
    ...
    // Use cacheBust and skipFonts to handle CORS issues with external images
    const dataUrl = await toPng(element, {
        quality: 0.95,
        pixelRatio: 2, // Higher quality for retina displays
        backgroundColor: null, // Transparent background
        cacheBust: true, // Bust cache to avoid CORS issues with external images
        skipFonts: true, // Skip font embedding to avoid CORS errors
    })
