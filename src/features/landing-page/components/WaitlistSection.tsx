                  ...
                  <div ref={formContainerRef} className="space-y-5">
                    ...
                    <div className="rounded-xl border border-border/60 bg-background/50 px-4 py-4 text-center shadow-sm sm:px-5">
                      <div className="space-y-3">
                        ...
                        >
                          {showInviteInput ? "Hide invite code" : "Have an invite code?"}
                        </button>
                          ...
                          <div className="space-y-3">
                            <form onSubmit={handleInviteSubmit} className="space-y-3">
                              <Input
                                ...
                                className="h-10 rounded-lg border-border bg-background/80 text-center shadow-sm"
                              />
                              <Button
                                type="submit"
                                variant="ghost"
                                disabled={inviteChecking}
                                className="h-10 w-full rounded-lg border border-border hover:bg-muted"
                              >
