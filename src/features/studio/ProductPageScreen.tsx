...
export function ProductPageView() {
  ...
  return (
    ...
    <div className="flex flex-1 flex-col items-center justify-start overflow-hidden px-2 pb-3 pt-4">
          ...
          <section className="flex flex-col gap-2 px-2.5 pb-1">
            <div className="flex w-full gap-1 px-1">
              ...
              <div className="flex w-12 flex-col items-stretch rounded-2xl bg-card/80 px-1 py-0">
                ...
                <button 
                  type="button"
                  className={`inline-flex items-center justify-center rounded-lg px-1 py-1 text-xs font-medium transition-colors hover:bg-muted/50 ${isProductSaved ? 'text-red-500' : 'text-foreground'}`}
                  onClick={(e) => {
                    e.stopPropagation()
      ...
      {/* Wrap in stopPropagation div to prevent clashes with parent swipe handlers */}
      <div 
