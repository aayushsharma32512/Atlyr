...
export function StudioScrollUpView() {
  ...
  const handleSaveOutfit = useCallback(
    async (data: {
      ...
      try {
        ...
        const moodboardLabelBySlug = new Map(moodboards.map((m) => [m.slug, m.label] as const))
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
      ...
      >
        <section className="flex h-[36vh] fixed z-10 top-0 left-0 right-0 flex-none items-end justify-center gap-3 px-4 bg-card py-3">
          ...
          <RightActionRail
            ...
            onCheckpoint={isViewOnly ? undefined : toggleCheckpoint}
            onRedo={isViewOnly ? undefined : redo}
            onUndo={isViewOnly ? undefined : undo}
            className={isHeroLoading ? "pointer-events-none opacity-50" : undefined}
          />
        </section>
        ...
        <div className="flex flex-1 min-h-0 items-start justify-center px-0">
          ...
          <div className="flex w-full flex-1 min-h-0 flex-col gap-0.5 px-1">
            ...
            <div className="flex fixed bottom-11 py-1 bg-card left-0 right-0">
            <ScrollUpActionRow
              className="mt-0.0"
          ...
          relatedOutfits.map(({ outfit, studioOutfit }, index) => {
            ...
            return (
              <OutfitInspirationTile
                ...
                outfitId={studioOutfit?.id ?? outfit.id}
