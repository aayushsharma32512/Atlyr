...
export function StudioAlternativesView() {
  ...
  }, [heroProduct?.productUrl, isViewOnly])
  ...
  return (
    ...
    <div className="h-full w-full relative">
      ...
      >
          ...
          >
            ...
            >
              ...
              <IconButton
                ...
                className="absolute bottom-2 right-[-6px] z-10 rounded-xl bg-card h-9 w-9 text-muted-foreground hover:bg-muted/40 hover:text-foreground"
                onClick={openStudio}
              >
        ...
        {(
          <section 
            className="relative flex h-[calc(100% - 6rem)] min-h-0 mb-4 flex-1 flex-col gap-0 overflow-hidden rounded-1xl bg-card/90 p-0 transition-all duration-200"
            style={{ 
