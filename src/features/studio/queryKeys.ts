...
export const studioKeys = {
  ...
  productOutfits: (productId: string | null | undefined, slot: StudioProductTraySlot | null | undefined) =>
    [...studioKeys.all, "product-outfits", productId ?? "none", slot ?? "none"] as const,
  ...
  categoryOutfits: (category: string | null | undefined) => [...studioKeys.all, "category-outfits", category ?? "none"] as const,
