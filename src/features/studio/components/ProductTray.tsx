...
export function ProductTray({
  ...
  return (
    <section className="mx-auto w-full max-w-sm rounded-t-3xl bg-card px-1 pb-0 pt-1">
        ...
        {isLoading ? (
          ...
          (localSlotOrder ?? slotOrder ?? []).map((slot, index) => {
            ...
            return (
              ...
              >
                <div
                  className="transition-transform w-[76%]  relative duration-200"
                  style={!isDragged && translateY !== 0 ? { transform: `translateY(${translateY}px)` } : undefined}
                >
                  <ProductSummaryCard
                    className="w-full"
                    ...
                    onClick={
                      !isReadOnly && onProductPress ? () => onProductPress(product) : undefined
                    }
                    onDragStart={
